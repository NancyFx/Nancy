namespace Nancy.Tests.Functional.Tests
{
    ...
    public class JsonpTests
    {
        ...
        {
            var result = await browser.GetAsync("/test/string", c =>
            {
                c.HttpRequest();
            });
        ...
        {
            var result = await browser.GetAsync("/test/something", c => c.HttpRequest());
        ...
        {
            var result = await browser.GetAsync("/test/json", c =>
            {
                c.HttpRequest();
            });
        ...
        {
            var result = await browser.GetAsync("/test/json", with =>
            {
                with.HttpRequest();
