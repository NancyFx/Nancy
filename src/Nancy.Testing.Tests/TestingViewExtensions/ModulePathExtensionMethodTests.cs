namespace Nancy.Testing.Tests.TestingViewExtensions
{
    ...
    public class ModulePathExtensionMethodTests
    {
        [Fact]
        ...
        [Fact]
        public void should_get_empty_string_for_module_with_no_module_path_set()
        {
            // Arrange
            var browser = new Browser(with =>
            {
    ...
    public class ModuleWithLongModulePath : NancyModule
    {
        public ModuleWithLongModulePath()
            : base("/a/long/path")
        {
            this.Get["/getModulePath"] = _ => this.View["ViewFactoryTest.sshtml"];
        }
    }
