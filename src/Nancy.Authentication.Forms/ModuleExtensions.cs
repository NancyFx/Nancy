namespace Nancy.Authentication.Forms
{
    ...
    public static class ModuleExtensions
    {
        ...
        public static Response Login(this NancyModuleBase module, Guid userIdentifier, DateTime? cookieExpiry = null, string fallbackRedirectUrl = "/")
        {
        ...
        public static Response LoginAndRedirect(this NancyModuleBase module, Guid userIdentifier, DateTime? cookieExpiry = null, string fallbackRedirectUrl = "/")
        {
        ...
        /// <param name="cookieExpiry">Optional expiry date for the cookie (for 'Remember me')</param>
        /// <returns>Nancy response instance</returns>
        public static Response LoginWithoutRedirect(this NancyModuleBase module, Guid userIdentifier, DateTime? cookieExpiry = null)
        {
        ...
        /// <returns>Nancy response with redirect if request was not ajax, otherwise with OK.</returns>
        public static Response Logout(this NancyModuleBase module, string redirectUrl)
        {
            return module.Context.Request.IsAjaxRequest() ?
        ...
        /// <param name="redirectUrl">URL to redirect to</param>
        /// <returns>Nancy response instance</returns>
        public static Response LogoutAndRedirect(this NancyModuleBase module, string redirectUrl)
        {
        ...
        /// <param name="module">Nancy module</param>
        /// <returns>Nancy response instance</returns>
        public static Response LogoutWithoutRedirect(this NancyModuleBase module)
        {
