...
namespace Nancy
{
    ...
    public class DefaultNancyBootstrapper : NancyBootstrapperWithRequestContainerBase<TinyIoCContainer>
    {
        ...
        protected override sealed IEnumerable<NancyModuleBase> GetAllModules(TinyIoCContainer container)
        {
            var nancyModules = container.ResolveAll<NancyModuleBase>(false);
            return nancyModules;
        }
        ...
        protected override sealed NancyModuleBase GetModuleByKey(TinyIoCContainer container, string moduleKey)
        {
