namespace Nancy.Json
{
    ...
    public static class JsonConfigurationExtensions
    {
        ...
        public static void Json(this INancyEnvironment environment, int? maxJsonLength = null, int? maxRecursions = null, Encoding defaultEncoding = null, IList<JavaScriptConverter> converters = null, IList<JavaScriptPrimitiveConverter> primitiveConverters = null, bool? retainCasing = null)
        {
