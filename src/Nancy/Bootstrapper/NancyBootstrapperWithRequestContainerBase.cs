namespace Nancy.Bootstrapper
{
        ...
        where TContainer : class
    {
        ...
        protected abstract IEnumerable<NancyModuleBase> GetAllModules(TContainer container);
        ...
        protected abstract NancyModuleBase GetModuleByKey(TContainer container, string moduleKey);
    }
}