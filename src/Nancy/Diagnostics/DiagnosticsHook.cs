namespace Nancy.Diagnostics
{
    ...
    public static class DiagnosticsHook
    {
            ...
            IEnumerable<IRouteMetadataProvider> routeMetadataProviders)
        {
            ...
            var diagnosticsRouteCache = new RouteCache(diagnosticsModuleCatalog, new DefaultNancyContextFactory(cultureService), requestTraceFactory), new DefaultRouteSegmentExtractor(), new DefaultRouteDescriptionProvider(), cultureService, routeMetadataProvider);
