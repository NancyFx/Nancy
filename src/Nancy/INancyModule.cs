namespace Nancy
{
    ...
    public interface INancyModule
    {
        ...
        /// <summary>
        ///  Gets or sets an <see cref="P:Nancy.NancyModuleBase.Request" /> instance that represents the current request.
        ///  </summary><value>An <see cref="P:Nancy.NancyModuleBase.Request" /> instance.</value>
