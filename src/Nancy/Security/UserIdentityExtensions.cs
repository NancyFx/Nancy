    ...
    public static class UserIdentityExtensions
    {
        ...
        public static bool HasClaim(this IUserIdentity user, string requiredClaim)
        {
            return
                user != null
                && user.Claims != null
                && user.Claims.Contains(requiredClaim, StringComparer.InvariantCultureIgnoreCase);
        }
        ...
        public static bool HasClaims(this IUserIdentity user, IEnumerable<string> requiredClaims)
        {
            return
                user != null
                && user.Claims != null
                && !requiredClaims.Any(claim => !user.Claims.Contains(claim, StringComparer.InvariantCultureIgnoreCase));
        }
