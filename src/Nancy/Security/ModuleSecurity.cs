namespace Nancy.Security
{
    ...
    public static class ModuleSecurity
    {
        ...
        public static void RequiresAuthentication(this NancyModuleBase module)
        {
        ...
        public static void RequiresClaims(this NancyModuleBase module, IEnumerable<string> requiredClaims)
        {
            module.Before.AddItemToEndOfPipeline(RequiresAuthentication);
        ...
        /// <param name="module">Module to enable</param>
        /// <param name="requiredClaims">Claim(s) required</param>
        public static void RequiresAnyClaim(this NancyModuleBase module, IEnumerable<string> requiredClaims)
        {
            module.Before.AddItemToEndOfPipeline(RequiresAuthentication);
        ...
        public static void RequiresValidatedClaims(this NancyModuleBase module, Func<IEnumerable<string>, bool> isValid)
        {
        ...
        public static void RequiresHttps(this NancyModuleBase module)
        {
        ...
        public static void RequiresHttps(this NancyModuleBase module, bool redirect)
        {
