namespace Nancy.Security
{
    ...
    public static class Csrf
    {
        ...
        /// <returns></returns>
        public static void CreateNewCsrfToken(this NancyModuleBase module)
        {
            var token = new CsrfToken
            {
                CreatedDate = DateTime.Now,
        ...
        public static void ValidateCsrfToken(this NancyModuleBase module, TimeSpan? validityPeriod = null)
        {
